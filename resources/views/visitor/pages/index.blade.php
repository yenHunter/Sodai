                    ...
                    <div class="ec-sidebar-block">
                            ...
                            <ul>
                                <li>
                                    <div class="ec-sidebar-block-item">
                                        <img src="{{ asset('visitor/images/icons/dress-8.png') }}"
                        ...
                        <div class="ec-sb-block-content">
                            <ul>
                                <li>
                                    <div class="ec-sidebar-block-item">
                                        <img src="{{ asset('visitor/images/icons/shoes-8.png') }}"
                        ...
                        <div class="ec-sb-block-content">
                            <ul>
                                <li>
                                    <div class="ec-sidebar-block-item">
                                        <img src="{{ asset('visitor/images/icons/jewelry-8.png') }}"
                        ...
                        <div class="ec-sb-block-content">
                            <ul>
                                <li>
                                    <div class="ec-sidebar-block-item">
                                        <img src="{{ asset('visitor/images/icons/perfume-8.png') }}"
                        ...
                        <div class="ec-sb-block-content">
                            <ul>
                                <li>
                                    <div class="ec-sidebar-block-item">
                                        <img src="{{ asset('visitor/images/icons/cosmetics-8.png') }}"
                        ...
                        <div class="ec-sb-block-content">
                            <ul>
                                <li>
                                    <div class="ec-sidebar-block-item">
                                        <img src="{{ asset('visitor/images/icons/glasses-8.png') }}"
                        ...
                        <div class="ec-sb-block-content">
                            <ul>
                                <li>
                                    <div class="ec-sidebar-block-item">
                                        <img src="{{ asset('visitor/images/icons/bag-8.png') }}"
                ...
                <div class="ec-sb-pro-sl">
                    <div>
                        <div class="ec-sb-pro-sl-item">
                            <a href="product-left-sidebar.html" class="sidekka_pro_img">
                                <img
                                    src="{{ asset('visitor/images/product-image/1.jpg') }}" alt="product" /></a>
                    ...
                    <div>
                        <div class="ec-sb-pro-sl-item">
                            <a href="product-left-sidebar.html" class="sidekka_pro_img">
                                <img
                                    src="{{ asset('visitor/images/product-image/2.jpg') }}" alt="product" />
                            </a>
                            <div class="ec-pro-content">
                    ...
                    <div>
                        <div class="ec-sb-pro-sl-item">
                            <a href="product-left-sidebar.html" class="sidekka_pro_img">
                                <img
                                    src="{{ asset('visitor/images/product-image/3.jpg') }}" alt="product" />
                            </a>
                            <div class="ec-pro-content">
                    ...
                    <div>
                        <div class="ec-sb-pro-sl-item">
                            <a href="product-left-sidebar.html" class="sidekka_pro_img">
                                <img
                                    src="{{ asset('visitor/images/product-image/4.jpg') }}" alt="product" />
                            </a>
                            <div class="ec-pro-content">
                    ...
                    <div>
                        <div class="ec-sb-pro-sl-item">
                            <a href="product-left-sidebar.html" class="sidekka_pro_img">
                                <img
                                    src="{{ asset('visitor/images/product-image/5.jpg') }}" alt="product" />
                            </a>
                            <div class="ec-pro-content">
                    ...
                    <div>
                        <div class="ec-sb-pro-sl-item">
                            <a href="product-left-sidebar.html" class="sidekka_pro_img">
                                <img
                                    src="{{ asset('visitor/images/product-image/6.jpg') }}" alt="product" />
                            </a>
                            <div class="ec-pro-content">
                    ...
                    <div>
                        <div class="ec-sb-pro-sl-item">
                            <a href="product-left-sidebar.html" class="sidekka_pro_img">
                                <img
                                    src="{{ asset('visitor/images/product-image/7.jpg') }}" alt="product" />
                            </a>
                            <div class="ec-pro-content">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content"
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset('visitor/images/product-image/3_1.jpg') }}"
                                                        alt="Product" />
                                                    <img class="hover-image" src="{{ asset('visitor/images/product-image/3_2.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/3_1.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/3_1.jpg') }}"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#75e3ff;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/3_2.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/3_2.jpg') }}"
                                                                data-tooltip="Orange"><span
                                                                    style="background-color:#11f7d8;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/3_3.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/3_3.jpg') }}"
                                                                data-tooltip="Green"><span
                                                                    style="background-color:#acff7c;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/3_5.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/3_5.jpg') }}"
                                                                data-tooltip="Sky Blue"><span
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content"
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset('visitor/images/product-image/4_1.jpg') }}"
                                                        alt="Product" />
                                                    <img class="hover-image" src="{{ asset('visitor/images/product-image/4_2.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                                <a href="#" class="quickview" data-link-action="quickview"
                                                    title="Quick view" data-bs-toggle="modal"
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/4_1.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/4_1.jpg') }}"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#ebbf60;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/4_2.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/4_2.jpg') }}"
                                                                data-tooltip="Orange"><span
                                                                    style="background-color:#b4fc57;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/4_3.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/4_3.jpg') }}"
                                                                data-tooltip="Green"><span
                                                                    style="background-color:#2ea1cd;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/4_4.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/4_4.jpg') }}"
                                                                data-tooltip="Sky Blue"><span
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content"
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset('visitor/images/product-image/5_1.jpg') }}"
                                                        alt="Product" />
                                                    <img class="hover-image" src="{{ asset('visitor/images/product-image/5_2.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                                <span class="flags">
                                                    <span class="new">New</span>
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/5_1.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/5_1.jpg') }}"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#9e9e9e;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/5_2.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/5_2.jpg') }}"
                                                                data-tooltip="Orange"><span
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content">
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset('visitor/images/product-image/10_1.jpg') }}"
                                                        alt="Product" />
                                                    <img class="hover-image" src="{{ asset('visitor/images/product-image/10_2.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                                <span class="flags">
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/10_1.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/10_1.jpg') }}"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#41d49c;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/10_2.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/10_2.jpg') }}"
                                                                data-tooltip="Orange"><span
                                                                    style="background-color:#fc8484;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/10_3.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/10_3.jpg') }}"
                                                                data-tooltip="Green"><span
                                                                    style="background-color:#db94f7;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/10_4.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/10_4.jpg') }}"
                                                                data-tooltip="Sky Blue"><span
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content">
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset('visitor/images/product-image/9_1.jpg') }}"
                                                        alt="Product" />
                                                    <img class="hover-image" src="{{ asset('visitor/images/product-image/9_2.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                                <span class="flags">
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/9_1.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/9_1.jpg') }}"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#21b7fc;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/9_2.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/9_2.jpg') }}"
                                                                data-tooltip="Orange"><span
                                                                    style="background-color:#1df0ff;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/9_3.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/9_3.jpg') }}"
                                                                data-tooltip="Green"><span
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content">
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset('visitor/images/product-image/11_1.jpg') }}"
                                                        alt="Product" />
                                                    <img class="hover-image" src="{{ asset('visitor/images/product-image/11_2.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                                <span class="flags">
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/11_1.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/11_1.jpg') }}"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#dba4ff;"></span></a>
                                                        </li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/11_2.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/11_2.jpg') }}"
                                                                data-tooltip="Orange"><span
                                                                    style="background-color:#ff4a77;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/11_3.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/11_3.jpg') }}"
                                                                data-tooltip="Green"><span
                                                                    style="background-color:#c9ff55;"></span></a>
                                                        </li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/11_4.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/11_4.jpg') }}"
                                                                data-tooltip="Sky Blue"><span
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content">
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset('visitor/images/product-image/12_1.jpg') }}"
                                                        alt="Product" />
                                                    <img class="hover-image" src="{{ asset('visitor/images/product-image/12_2.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                                <span class="flags">
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/12_1.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/12_1.jpg') }}"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#db9dff;"></span></a>
                                                        </li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/12_2.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/12_2.jpg') }}"
                                                                data-tooltip="Orange"><span
                                                                    style="background-color:#00ffff;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/12_3.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/12_3.jpg') }}"
                                                                data-tooltip="Green"><span
                                                                    style="background-color:#ffa7f3;"></span></a>
                                                        </li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/12_4.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/12_4.jpg') }}"
                                                                data-tooltip="Sky Blue"><span
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content">
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset('visitor/images/product-image/13_1.jpg') }}"
                                                        alt="Product" />
                                                    <img class="hover-image" src="{{ asset('visitor/images/product-image/13_2.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                                <a href="#" class="quickview" data-link-action="quickview"
                                                    title="Quick view" data-bs-toggle="modal"
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/13_1.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/13_1.jpg') }}"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#deffa4;"></span></a>
                                                        </li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/13_2.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/13_2.jpg') }}"
                                                                data-tooltip="Orange"><span
                                                                    style="background-color:#ffcdbe;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/13_3.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/13_3.jpg') }}"
                                                                data-tooltip="Green"><span
                                                                    style="background-color:#ff94df;"></span></a>
                                                        </li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/13_4.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/13_4.jpg') }}"
                                                                data-tooltip="Sky Blue"><span
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content">
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset('visitor/images/product-image/14_1.jpg') }}"
                                                        alt="Product" />
                                                    <img class="hover-image" src="{{ asset('visitor/images/product-image/14_2.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                                <a href="#" class="quickview" data-link-action="quickview"
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/14_1.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/14_1.jpg') }}"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#bb8641;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/14_2.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/14_2.jpg') }}"
                                                                data-tooltip="Orange"><span
                                                                    style="background-color:#5dd677;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/14_3.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/14_3.jpg') }}"
                                                                data-tooltip="Green"><span
                                                                    style="background-color:#32ffdd;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/14_4.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/14_4.jpg') }}"
                                                                data-tooltip="Sky Blue"><span
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content">
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset('visitor/images/product-image/15_1.jpg') }}"
                                                        alt="Product" />
                                                    <img class="hover-image" src="{{ asset('visitor/images/product-image/15_2.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                                <span class="flags">
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/15_1.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/15_1.jpg') }}"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#ffacfb;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/15_2.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/15_2.jpg') }}"
                                                                data-tooltip="Orange"><span
                                                                    style="background-color:#90dfff;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/15_3.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/15_3.jpg') }}"
                                                                data-tooltip="Green"><span
                                                                    style="background-color:#c6ff4a;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/15_4.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/15_4.jpg') }}"
                                                                data-tooltip="Sky Blue"><span
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content">
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset('visitor/images/product-image/16_1.jpg') }}"
                                                        alt="Product" />
                                                    <img class="hover-image" src="{{ asset('visitor/images/product-image/16_2.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                                <span class="flags">
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/16_1.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/16_1.jpg') }}"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#6ee9ff;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/16_2.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/16_2.jpg') }}"
                                                                data-tooltip="Orange"><span
                                                                    style="background-color:#eb99ff;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/16_3.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/16_3.jpg') }}"
                                                                data-tooltip="Green"><span
                                                                    style="background-color:#ff6464;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/16_4.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/16_4.jpg') }}"
                                                                data-tooltip="Sky Blue"><span
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content">
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset('visitor/images/product-image/17_1.jpg') }}"
                                                        alt="Product" />
                                                    <img class="hover-image" src="{{ asset('visitor/images/product-image/17_2.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                                <span class="flags">
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/17_1.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/17_1.jpg') }}"
                                                                data-tooltip="Gray"><span
                                                                    style="background-color:#8ad2fc;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/17_2.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/17_2.jpg') }}"
                                                                data-tooltip="Orange"><span
                                                                    style="background-color:#ff8ef6;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/17_3.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/17_3.jpg') }}"
                                                                data-tooltip="Green"><span
                                                                    style="background-color:#ffbe31;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="{{ asset('visitor/images/product-image/17_4.jpg') }}"
                                                                data-src-hover="{{ asset('visitor/images/product-image/17_4.jpg') }}"
                                                                data-tooltip="Sky Blue"><span
                    ...
                    <div class="row">
                        <div class="banner-block col-lg-6 col-md-12 margin-b-30" data-animation="slideInRight">
                            <div class="bnr-overlay">
                                <img src="{{ asset('visitor/images/banner/2.jpg') }}" alt="" />
                        ...
                        <div class="banner-block col-lg-6 col-md-12" data-animation="slideInLeft">
                            <div class="bnr-overlay">
                                <img src="{{ asset('visitor/images/banner/3.jpg') }}" alt="" />
                                <div class="banner-text">
                ...
                <div class="col-lg-3">
                    <ul class="ec-cat-tab-nav nav">
                        <li class="cat-item"><a class="cat-link active" data-bs-toggle="tab" href="#tab-cat-1">
                                <div class="cat-icons"><img class="cat-icon" src="{{ asset('visitor/images/icons/cat_1.png') }}"
                                        alt="cat-icon"><img class="cat-icon-hover" src="{{ asset('visitor/images/icons/cat_1_1.png') }}"
                                        alt="cat-icon"></div>
                        ...
                        <li class="cat-item"><a class="cat-link" data-bs-toggle="tab" href="#tab-cat-2">
                                <div class="cat-icons"><img class="cat-icon" src="{{ asset('visitor/images/icons/cat_2.png') }}"
                                        alt="cat-icon"><img class="cat-icon-hover" src="{{ asset('visitor/images/icons/cat_2_1.png') }}"
                                        alt="cat-icon"></div>
                        ...
                        <li class="cat-item"><a class="cat-link" data-bs-toggle="tab" href="#tab-cat-3">
                                <div class="cat-icons"><img class="cat-icon" src="{{ asset('visitor/images/icons/cat_3.png') }}"
                                        alt="cat-icon"><img class="cat-icon-hover" src="{{ asset('visitor/images/icons/cat_3_1.png') }}"
                                        alt="cat-icon"></div>
                        ...
                        <li class="cat-item"><a class="cat-link" data-bs-toggle="tab" href="#tab-cat-4">
                                <div class="cat-icons"><img class="cat-icon" src="{{ asset('visitor/images/icons/cat_4.png') }}"
                                        alt="cat-icon"><img class="cat-icon-hover" src="{{ asset('visitor/images/icons/cat_4_1.png') }}"
                                        alt="cat-icon"></div>
                ...
                <div class="col-lg-9">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="tab-cat-1">
                            <div class="row">
                                <img src="{{ asset('visitor/images/cat-banner/1.jpg') }}" alt="" />
                            </div>
                        ...
                        <div class="tab-pane fade" id="tab-cat-2">
                            <div class="row">
                                <img src="{{ asset('visitor/images/cat-banner/2.jpg') }}" alt="" />
                            </div>
                            <span class="panel-overlay">
                                <a href="shop-left-sidebar-col-3.html" class="btn btn-primary">View All</a>
                            </span>
                        ...
                        <div class="tab-pane fade" id="tab-cat-3">
                            <div class="row">
                                <img src="{{ asset('visitor/images/cat-banner/3.jpg') }}" alt="" />
                            </div>
                            <span class="panel-overlay">
                                <a href="shop-left-sidebar-col-3.html" class="btn btn-primary">View All</a>
                            </span>
                        ...
                        <div class="tab-pane fade" id="tab-cat-4">
                            <div class="row">
                                <img src="{{ asset('visitor/images/cat-banner/4.jpg') }}" alt="" />
                            </div>
                            <span class="panel-overlay">
                                <a href="shop-left-sidebar-col-3.html" class="btn btn-primary">View All</a>
                            </span>
                                ...
                                <div class="ec-fs-pro-image-outer col-lg-6 col-md-6 col-sm-6">
                                    <div class="ec-fs-pro-image">
                                        <a href="product-left-sidebar.html" class="image"><img class="main-image"
                                                src="{{ asset('visitor/images/product-image/1_1.jpg') }}" alt="Product" /></a>
                        ...
                        <div class="ec-fs-product">
                            <div class="ec-fs-pro-inner">
                                <div class="ec-fs-pro-image-outer col-lg-6 col-md-6 col-sm-6">
                                    <div class="ec-fs-pro-image">
                                        <a href="product-left-sidebar.html" class="image"><img class="main-image"
                                                src="{{ asset('visitor/images/product-image/3_1.jpg') }}" alt="Product" /></a>
                                        <a href="#" class="quickview" data-link-action="quickview" title="Quick view"
                                            data-bs-toggle="modal" data-bs-target="#ec_quickview_modal"><i
                                                class="fi-rr-eye"></i></a>
                                    </div>
                        ...
                        <div class="ec-fs-product">
                            <div class="ec-fs-pro-inner">
                                <div class="ec-fs-pro-image-outer col-lg-6 col-md-6 col-sm-6">
                                    <div class="ec-fs-pro-image">
                                        <a href="product-left-sidebar.html" class="image"><img class="main-image"
                                                src="{{ asset('visitor/images/product-image/8_1.jpg') }}" alt="Product" /></a>
                                        <a href="#" class="quickview" data-link-action="quickview" title="Quick view"
                                            data-bs-toggle="modal" data-bs-target="#ec_quickview_modal"><i
                                                class="fi-rr-eye"></i></a>
                                    </div>
                        ...
                        <div class="ec-fs-product">
                            <div class="ec-fs-pro-inner">
                                <div class="ec-fs-pro-image-outer col-lg-6 col-md-6 col-sm-6">
                                    <div class="ec-fs-pro-image">
                                        <a href="product-left-sidebar.html" class="image"><img class="main-image"
                                                src="{{ asset('visitor/images/product-image/10_1.jpg') }}" alt="Product" /></a>
                                        <a href="#" class="quickview" data-link-action="quickview" title="Quick view"
                                            data-bs-toggle="modal" data-bs-target="#ec_quickview_modal"><i
                                                class="fi-rr-eye"></i></a>
                                    </div>
            ...
            <div class="row margin-minus-t-15 margin-minus-b-15">
                    ...
                    <div class="ec-vendor-card">
                        <div class="ec-vendor-detail">
                            <div class="ec-vendor-avtar">
                                <img src="{{ asset('visitor/images/vendor/2.jpg') }}" alt="vendor img">
                            </div>
                        ...
                        <div class="ec-vendor-prod">
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{ asset('visitor/images/product-image/1_1.jpg') }}"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{ asset('visitor/images/product-image/2_1.jpg') }}"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{ asset('visitor/images/product-image/3_1.jpg') }}"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{ asset('visitor/images/product-image/4_1.jpg') }}"
                                        alt="vendor img"></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-3 ec_ven_content" data-animation="zoomIn">
                    <div class="ec-vendor-card">
                        <div class="ec-vendor-detail">
                            <div class="ec-vendor-avtar">
                                <img src="{{ asset('visitor/images/vendor/3.jpg') }}" alt="vendor img">
                            </div>
                            <div class="ec-vendor-info">
                        ...
                        <div class="ec-vendor-prod">
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{ asset('visitor/images/product-image/5_1.jpg') }}"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{ asset('visitor/images/product-image/6_1.jpg') }}"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{ asset('visitor/images/product-image/7_1.jpg') }}"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{ asset('visitor/images/product-image/8_1.jpg') }}"
                                        alt="vendor img"></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-3 ec_ven_content" data-animation="zoomIn">
                    <div class="ec-vendor-card">
                        <div class="ec-vendor-detail">
                            <div class="ec-vendor-avtar">
                                <img src="{{ asset('visitor/images/vendor/4.jpg') }}" alt="vendor img">
                            </div>
                            <div class="ec-vendor-info">
                        ...
                        <div class="ec-vendor-prod">
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{ asset('visitor/images/product-image/9_1.jpg') }}"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{ asset('visitor/images/product-image/10_1.jpg') }}"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{ asset('visitor/images/product-image/11_1.jpg') }}"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{ asset('visitor/images/product-image/12_1.jpg') }}"
                                        alt="vendor img"></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-3 ec_ven_content" data-animation="zoomIn">
                    <div class="ec-vendor-card">
                        <div class="ec-vendor-detail">
                            <div class="ec-vendor-avtar">
                                <img src="{{ asset('visitor/images/vendor/5.jpg') }}" alt="vendor img">
                            </div>
                            <div class="ec-vendor-info">
                        ...
                        <div class="ec-vendor-prod">
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{ asset('visitor/images/product-image/13_1.jpg') }}"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{ asset('visitor/images/product-image/14_1.jpg') }}"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{ asset('visitor/images/product-image/15_1.jpg') }}"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="product-left-sidebar.html"><img src="{{ asset('visitor/images/product-image/16_1.jpg') }}"
                                        alt="vendor img"></a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row justify-content-end">
                <div class="col-xl-6 col-lg-7 col-md-7 col-sm-7 align-self-center ec-offer-content">
                    ...
                    <span class="ec-offer-img" data-animation="zoomIn"><img src="{{ asset('visitor/images/offer-image/1.png') }}"
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content" data-animation="flipInY">
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.html" class="image">
                                    <img class="main-image" src="{{ asset('visitor/images/product-image/9_1.jpg') }}" alt="Product" />
                                    <img class="hover-image" src="{{ asset('visitor/images/product-image/9_2.jpg') }}" alt="Product" />
                                </a>
                                <span class="flags">
                                    <span class="sale">Sale</span>
                                </span>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content" data-animation="flipInY">
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.html" class="image">
                                    <img class="main-image" src="{{ asset('visitor/images/product-image/11_1.jpg') }}" alt="Product" />
                                    <img class="hover-image" src="{{ asset('visitor/images/product-image/11_2.jpg') }}" alt="Product" />
                                </a>
                                <span class="flags">
                                    <span class="new">New</span>
                                </span>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content" data-animation="flipInY">
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.html" class="image">
                                    <img class="main-image" src="{{ asset('visitor/images/product-image/12_1.jpg') }}" alt="Product" />
                                    <img class="hover-image" src="{{ asset('visitor/images/product-image/12_2.jpg') }}" alt="Product" />
                                </a>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content" data-animation="flipInY">
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.html" class="image">
                                    <img class="main-image" src="{{ asset('visitor/images/product-image/13_1.jpg') }}" alt="Product" />
                                    <img class="hover-image" src="{{ asset('visitor/images/product-image/13_2.jpg') }}" alt="Product" />
                                </a>
                                <a href="#" class="quickview" data-link-action="quickview" title="Quick view"
                                    data-bs-toggle="modal" data-bs-target="#ec_quickview_modal"><i
                                        class="fi-rr-eye"></i></a>
                ...
                <div class="ec-test-outer">
                    <ul id="ec-testimonial-slider">
                        <li class="ec-test-item">
                            ...
                            <div class="ec-test-inner">
                                <div class="ec-test-img"><img alt="testimonial" title="testimonial"
                                        src="{{ asset('visitor/images/testimonial/1.jpg') }}" /></div>
                        ...
                        <li class="ec-test-item ">
                            ...
                            <div class="ec-test-inner">
                                <div class="ec-test-img"><img alt="testimonial" title="testimonial"
                                        src="{{ asset('visitor/images/testimonial/2.jpg') }}" /></div>
                                <div class="ec-test-content">
                                    <div class="ec-test-desc">Lorem Ipsum is simply dummy text of the printing and
                                        typesetting industry. Lorem Ipsum has been the industry's standard dummy text
                                        ever since the 1500s, when an unknown printer took a galley of type and
                        ...
                        <li class="ec-test-item">
                            ...
                            <div class="ec-test-inner">
                                <div class="ec-test-img"><img alt="testimonial" title="testimonial"
                                        src="{{ asset('visitor/images/testimonial/3.jpg') }}" /></div>
                                <div class="ec-test-content">
                                    <div class="ec-test-desc">Lorem Ipsum is simply dummy text of the printing and
                                        typesetting industry. Lorem Ipsum has been the industry's standard dummy text
                                        ever since the 1500s, when an unknown printer took a galley of type and
                    ...
                    <ul id="ec-brand-slider">
                        <li class="ec-brand-item" data-animation="zoomIn">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                        src="{{ asset('visitor/images/brand-image/1.png') }}" /></a></div>
                        </li>
                        <li class="ec-brand-item" data-animation="zoomIn">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                        src="{{ asset('visitor/images/brand-image/2.png') }}" /></a></div>
                        </li>
                        <li class="ec-brand-item" data-animation="zoomIn">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                        src="{{ asset('visitor/images/brand-image/3.png') }}" /></a></div>
                        </li>
                        <li class="ec-brand-item" data-animation="zoomIn">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                        src="{{ asset('visitor/images/brand-image/4.png') }}" /></a></div>
                        </li>
                        <li class="ec-brand-item" data-animation="zoomIn">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                        src="{{ asset('visitor/images/brand-image/5.png') }}" /></a></div>
                        </li>
                        <li class="ec-brand-item" data-animation="zoomIn">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                        src="{{ asset('visitor/images/brand-image/6.png') }}" /></a></div>
                        </li>
                        <li class="ec-brand-item" data-animation="zoomIn">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                        src="{{ asset('visitor/images/brand-image/7.png') }}" /></a></div>
                        </li>
                        <li class="ec-brand-item" data-animation="zoomIn">
                            <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                        src="{{ asset('visitor/images/brand-image/8.png') }}" /></a></div>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="insta-auto">
                        ...
                        <div class="ec-insta-item">
                            <div class="ec-insta-inner">
                                <a href="#" target="_blank"><img src="{{ asset('visitor/images/instragram-image/1.jpg') }}"
                                        alt="insta"></a>
                            </div>
                        </div>
                        <!-- instagram item -->
                        <div class="ec-insta-item">
                            <div class="ec-insta-inner">
                                <a href="#" target="_blank"><img src="{{ asset('visitor/images/instragram-image/2.jpg') }}"
                                        alt="insta"></a>
                            </div>
                        </div>
                        <!-- instagram item -->
                        <div class="ec-insta-item">
                            <div class="ec-insta-inner">
                                <a href="#" target="_blank"><img src="{{ asset('visitor/images/instragram-image/3.jpg') }}"
                                        alt="insta"></a>
                            </div>
                        </div>
                        <!-- instagram item -->
                        <div class="ec-insta-item">
                            <div class="ec-insta-inner">
                                <a href="#" target="_blank"><img src="{{ asset('visitor/images/instragram-image/4.jpg') }}"
                                        alt="insta"></a>
                            </div>
                        </div>
                        <!-- instagram item -->
                        ...
                        <div class="ec-insta-item">
                            <div class="ec-insta-inner">
                                <a href="#" target="_blank"><img src="{{ asset('visitor/images/instragram-image/5.jpg') }}"
                                        alt="insta"></a>
                            </div>
                        </div>
                        <!-- instagram item -->
                        ...
                        <div class="ec-insta-item">
                            <div class="ec-insta-inner">
                                <a href="#" target="_blank"><img src="{{ asset('visitor/images/instragram-image/6.jpg') }}"
                                        alt="insta"></a>
                            </div>
                        </div>
                        <!-- instagram item -->
                        ...
                        <div class="ec-insta-item">
                            <div class="ec-insta-inner">
                                <a href="#" target="_blank"><img src="{{ asset('visitor/images/instragram-image/7.jpg') }}"
                                        alt="insta"></a>
                            </div>
                        </div>
                        <!-- instagram item -->
