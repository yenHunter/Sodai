                    ...
                    <div class="ec-shop-rightside col-lg-12 col-md-12">
                        ...
                        <div class="ec-pro-list-top d-flex">
                            <div class="col-md-6 ec-grid-list">
                                ...
                                @if (!empty($filters['category']) || !empty($filters['color']) || !empty($filters['size']) || $filters['price_min'] || $filters['price_max'])
                                    <a href="{{ route('visitor.products.index') }}" class="btn btn-sm btn-light ms-2">Clear Filters</a>
                                @endif
                            </div>
                        ...
                        <div class="ec-sidebar-wrap">
                            ...
                            @if ($categories->isNotEmpty())
                                <div class="ec-sidebar-block">
                                    <div class="ec-sb-title"><h3 class="ec-sidebar-title">Category</h3></div>
