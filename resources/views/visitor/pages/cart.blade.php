@extends('visitor.layout.app', ['title' => 'Sodai - About Us', 'bodyClass' => 'cart_page'])
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td data-label="Product" class="ec-cart-pro-name"><a
                                                            href="product-left-sidebar.html"><img
                                                                ...
                                                                src="{{ asset('visitor/images/product-image/1.jpg') }}"
                                                                alt="" />Stylish
                                                            Baby Shoes</a></td>
                                                ...
                                                <tr>
                                                    <td data-label="Product" class="ec-cart-pro-name"><a
                                                            href="product-left-sidebar.html"><img
                                                                class="ec-cart-pro-img mr-4"
                                                                src="{{ asset('visitor/images/product-image/2.jpg') }}"
                                                                alt="" />Unisex
                                                ...
                                                <tr>
                                                    <td data-label="Product" class="ec-cart-pro-name"><a
                                                            href="product-left-sidebar.html"><img
                                                                class="ec-cart-pro-img mr-4"
                                                                src="{{ asset('visitor/images/product-image/3.jpg') }}"
                                                ...
                                                <tr>
                                                    <td data-label="Product" class="ec-cart-pro-name"><a
                                                            href="product-left-sidebar.html"><img
                                                                class="ec-cart-pro-img mr-4"
                                                                src="{{ asset('visitor/images/product-image/4.jpg') }}"
                                                                alt="" />Wool
                                                            Hat For Men</a></td>
                                                    <td data-label="Price" class="ec-cart-pro-price"><span
