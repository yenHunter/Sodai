@extends('visitor.layout.app', ['title' => 'Sodai - About Us', 'bodyClass' => 'product_page'])
                                    ...
                                    <div class="single-product-scroll">
                                        <div class="single-product-cover">
                                            <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive" src="{{ asset('visitor/images/product-360/1_1.jpg') }}"
                                                    alt="">
                                            </div>
                                            <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive" src="{{ asset('visitor/images/product-360/1_2.jpg') }}"
                                                    alt="">
                                            </div>
                                            <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive" src="{{ asset('visitor/images/product-360/1_3.jpg') }}"
                                                    alt="">
                                            </div>
                                            <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive" src="{{ asset('visitor/images/product-360/1_4.jpg') }}"
                                                    alt="">
                                            </div>
                                            <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive" src="{{ asset('visitor/images/product-360/1_5.jpg') }}"
                                                    alt="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="ec-t-review-wrapper">
                                            <div class="ec-t-review-item">
                                                <div class="ec-t-review-avtar">
                                                    <img src="{{ asset('visitor/images/review-image/1.jpg') }}" alt="" />
                                                </div>
                                            ...
                                            <div class="ec-t-review-item">
                                                <div class="ec-t-review-avtar">
                                                    <img src="{{ asset('visitor/images/review-image/2.jpg') }}" alt="" />
                                                </div>
                                                <div class="ec-t-review-content">
                                                    <div class="ec-t-review-top">
