...
<body>
    <div class="email-wrapper">
        ...
        <div class="email-body">
            ...
            <p>
                Thanks for signing up at {{ config('app.name') }}. Please confirm your email address
                to activate your account — you'll need to verify before you can log in.
            </p>
            <div style="text-align: center;">
                <a href="{{ $verificationUrl }}" class="btn-set">Verify Email Address</a>
            </div>
