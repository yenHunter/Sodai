@extends('admin.include.vertical', ['title' => 'Contacts'])

@section('styles')
@endsection

@section('content')
    @include('admin.include.partials.page-title', ['subtitle' => 'Users', 'title' => 'Contacts'])
        ...
        <div class="col-md-6 col-xxl-3">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <div class="text-end text-muted fs-xs"><i class="me-1" data-lucide="refresh-ccw"></i> Updated 1 hour
                        ago</div>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-xxl-3">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <hr class="mt-3 border-dashed" />
                    <div class="text-end text-muted fs-xs"><i class="me-1" data-lucide="refresh-ccw"></i> Updated 2
                        hours ago</div>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-xxl-3">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <hr class="mt-3 border-dashed" />
                    <div class="text-end text-muted fs-xs"><i class="me-1" data-lucide="refresh-ccw"></i> Updated 3
                        hours ago</div>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-xxl-3">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <hr class="mt-3 border-dashed" />
                    <div class="text-end text-muted fs-xs"><i class="me-1" data-lucide="refresh-ccw"></i> Updated 10
                        mins ago</div>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-xxl-3">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <hr class="mt-3 border-dashed" />
                    <div class="text-end text-muted fs-xs"><i class="me-1" data-lucide="refresh-ccw"></i> Updated 45
                        mins ago</div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-xxl-3">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <hr class="mt-3 border-dashed" />
                    <div class="text-end text-muted fs-xs"><i class="me-1" data-lucide="refresh-ccw"></i> Updated 30
                        mins ago</div>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-xxl-3">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <hr class="mt-3 border-dashed" />
                    <div class="text-end text-muted fs-xs"><i class="me-1" data-lucide="refresh-ccw"></i> Updated 20
                        mins ago</div>
                </div>
            </div>
        </div>
