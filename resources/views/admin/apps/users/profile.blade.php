@extends('admin.include.vertical', ['title' => 'Profile'])

@section('styles')
@endsection

@section('content')
    @include('admin.include.partials.page-title', ['subtitle' => 'Pages', 'title' => 'Profile'])
                            ...
                            <div class="d-flex justify-content-center gap-2 mt-4 mb-2">
                                <a class="btn btn-icon rounded-circle btn-primary" href="#!" title="Facebook">
                                    <svg class="icon icon-tabler icons-tabler-outline icon-tabler-brand-facebook"
                                        fill="none" height="18" stroke="currentColor" stroke-linecap="round"
                                ...
                                <a class="btn btn-icon rounded-circle btn-info" href="#!" title="Twitter-x">
                                    <svg class="icon icon-tabler icons-tabler-outline icon-tabler-brand-x" fill="none"
                                ...
                                <a class="btn btn-icon rounded-circle btn-success" href="#!" title="Dribbble">
                                    <svg class="icon icon-tabler icons-tabler-outline icon-tabler-brand-dribbble"
                                        fill="none" height="18" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="2" viewbox="0 0 24 24" width="18"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M0 0h24v24H0z" fill="none" stroke="none"></path>
                                ...
                                <a class="btn btn-icon rounded-circle btn-secondary" href="#!" title="LinkedIn">
                                    <svg class="icon icon-tabler icons-tabler-outline icon-tabler-brand-linkedin"
                                        fill="none" height="18" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="2" viewbox="0 0 24 24" width="18"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M0 0h24v24H0z" fill="none" stroke="none"></path>
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            <div class="tab-pane" id="about-me">
                                ...
                                <p>
                                    I specialize in crafting developer-friendly admin panels and UI kits using frameworks
                                    like Bootstrap, Tailwind CSS, React, Vue, Angular, Laravel, and Next.js. My templates
                                    are designed to accelerate development and provide a
                                    strong foundation for web apps, SaaS platforms, and enterprise tools.
                                </p>
                                <p class="mb-0">
                                    I focus on delivering well-structured, pixel-perfect layouts with a user-centric
                                    approach—ensuring responsive design, clean code, and seamless user experiences. Whether
                                    you're building a CRM, analytics dashboard, or backend
                                    ...
                                    <table
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <h5 class="fs-sm my-1">
                                                        <a class="text-body" href="#">Blazor Admin Theme – Final
                                                            QA</a>
                                                    </h5>
                                            ...
                                            <tr>
                                                <td>
                                                    <h5 class="fs-sm my-1">
                                                        <a class="text-body" href="#">Bootstrap 5 Theme
                                                            Migration</a>
                                                    </h5>
                            ...
                            <div class="tab-pane show active" id="timeline">
                                ...
                                <div class="border border-light border-dashed rounded p-2 mb-3">
                                    ...
                                    <img alt="post-img" class="rounded" height="60"
                                ...
                                <div class="border border-light border-dashed rounded p-2 mb-3">
                                    ...
                                    <div class="fs-16 text-center mt-3 mb-4 fst-italic">
                                        ...
                                        OpenWeather API. Feeling excited to share the results with everyone soon. 🚀
                                    </div>
                                ...
                                <form>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <span class="form-text fs-xs fst-italic text-muted">
                                                    <a class="link-reset" href="#">Click here to change your
                                                        email</a>
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text">
                                                    <svg class="icon icon-tabler icons-tabler-outline icon-tabler-brand-x"
                                                        fill="none" height="16" stroke="currentColor"
                                                        stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                        viewbox="0 0 24 24" width="16"
                                                        xmlns="http://www.w3.org/2000/svg">
