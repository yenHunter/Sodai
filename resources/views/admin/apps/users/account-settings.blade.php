...
@section('content')
    @include('admin.include.partials.page-title', ['subtitle' => 'Pages', 'title' => 'Account Settings'])
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" id="userpassword" placeholder="Enter new password"
                                            type="password" />
                                        <span class="form-text fs-xs fst-italic text-muted">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" id="cwebsite" placeholder="https://yourcompany.com"
                                            type="text" />
                                    </div>
                                </div>
                            </div>
