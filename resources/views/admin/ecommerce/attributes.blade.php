@extends('admin.include.vertical', ['title' => 'Manage Attributes'])

@section('styles')
@endsection

@section('content')
    @include('admin.include.partials.page-title', ['subtitle' => 'Ecommerce', 'title' => 'Attributes'])
                ...
                <div class="card-header border-light justify-content-between">
                    <div class="d-flex gap-2">
                        <div class="app-search">
                            <input class="form-control" data-table-search="" placeholder="Search attributes..."
                                type="search" />
                            ...
                            <tr class="text-uppercase fs-xxs">
                                <th class="ps-3" style="width: 1%">
                                    <input class="form-check-input form-check-input-light fs-14 mt-0"
                                        data-table-select-all="" id="select-all-attributes" type="checkbox" />
                                </th>
    ...
    <div aria-hidden="true" aria-labelledby="addAttributeModalLabel" class="modal fade" id="addAttributeModal"
        tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-light rounded-3 shadow-sm">
                <div class="modal-header">
                    <h5 class="modal-title fw-semibold" id="addAttributeModalLabel"><i class="me-2"
                            data-lucide="circle-plus"></i> Add New Attribute</h5>
                ...
                <form id="addAttributeForm">
                    <div class="modal-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="attributeName" placeholder="e.g. Color, Size, Material"
                                    required="" type="text" />
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control" id="attributeValues"
                                    placeholder="Separate multiple values with commas (e.g. Red, Blue, Green)" rows="2"></textarea>
                                <small class="text-muted d-block mt-1">Applicable only for Dropdown or selectable
                                    attributes.</small>
                            </div>
                            <div class="col-12">
                                <div class="form-check form-switch">
                                    <input checked="" class="form-check-input" id="attributeStatus"
                                        type="checkbox" />
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-danger" type="submit"><i class="me-1" data-lucide="save"></i> Save
                            Attribute</button>
                    </div>
                </form>
            </div>
