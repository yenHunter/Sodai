...
@section('content')
    @include('admin.include.partials.page-title', ['subtitle' => 'Ecommerce', 'title' => 'Reviews'])
            ...
            <div class="card" data-table="" data-table-rows-per-page="5">
                            ...
                            <div class="row align-items-center g-0">
                                <div class="col-xl-7">
                                    <div class="d-flex align-items-center gap-4 p-4">
                                        ...
                                        <div>
                                            <h3 class="d-flex align-items-center gap-2 mb-2 fw-bold">4.92 <i
                                                    class="text-warning" data-lucide="star"></i></h3>
                                        ...
                                        <div class="d-flex align-items-center gap-2 mb-2">
                                            ...
                                            <div class="progress w-100 bg-label-primary" style="height: 8px">
                                                <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="85"
                                                    class="progress-bar bg-primary" role="progressbar" style="width: 85%">
                                                </div>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-center gap-2 mb-2">
                                            ...
                                            <div class="progress w-100 bg-label-primary" style="height: 8px">
                                                <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="10"
                                                    class="progress-bar bg-primary" role="progressbar" style="width: 10%">
                                                </div>
                                            </div>
                                            <div class="flex-shrink-0 text-end" style="width: 30px"><span
                                        ...
                                        <div class="d-flex align-items-center gap-2 mb-2">
                                            ...
                                            <div class="progress w-100 bg-label-primary" style="height: 8px">
                                                <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="3"
                                                    class="progress-bar bg-primary" role="progressbar" style="width: 3%">
                                                </div>
                                            </div>
                                            <div class="flex-shrink-0 text-end" style="width: 30px"><span
                ...
                <div class="card-header border-light d-flex align-items-center justify-content-between flex-wrap gap-2">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <div class="dropdown">
                            <button aria-expanded="false" class="btn btn-default dropdown-toggle drop-arrow-none"
                                data-bs-toggle="dropdown" type="button">View All <i class="align-middle ms-1"
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h5 class="mb-0">
                                                <a class="link-reset" data-sort="product"
                                                    href="{{ url('/apps/ecommerce/product-details') }}">Smart Watch</a>
                                            </h5>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h5 class="mb-0">
                                                <a class="link-reset" data-sort="product"
                                                    href="{{ url('/apps/ecommerce/product-details') }}">4K Ultra HD TV</a>
                                            </h5>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h5 class="mb-0">
                                                <a class="link-reset" data-sort="product"
                                                    href="{{ url('/apps/ecommerce/product-details') }}">Smartphone X</a>
                                            </h5>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h5 class="mb-0">
                                                <a class="link-reset" data-sort="product"
                                                    href="{{ url('/apps/ecommerce/product-details') }}">Gaming Laptop</a>
                                            </h5>
                                        </div>
                                    </div>
                                </td>
