@extends('admin.include.vertical', ['title' => 'Shopping Cart'])

@section('styles')
@endsection

@section('content')
    @include('admin.include.partials.page-title', ['subtitle' => 'Ecommerce', 'title' => 'Cart'])

    <div class="row">
        <div class="col-12">
            <div class="alert alert-info border border-info border-opacity-25">
                <h6 class="mb-2">Buy <span class="fw-bold text-warning">$250</span> more to get <span
                        class="fw-semibold">Free Shipping</span></h6>
        ...
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                            ...
                            <tbody>
                                <tr>
                                    <td class="d-flex align-items-center">
                                        <img alt="iPhone" class="me-3 rounded" src="/images/products/1.png"
                                            width="60" />
                                        <div>
                                    ...
                                    <td>
                                        <div class="input-group" data-touchspin="" style="max-width: 130px">
                                            ...
                                            <input class="form-control form-control-sm border-0" max="800000"
                                                type="number" value="1" />
                                ...
                                <tr>
                                    <td class="d-flex align-items-center">
                                        <img alt="iPad" class="me-3 rounded" src="/images/products/2.png"
                                            width="60" />
                                        <div>
                                ...
                                <tr>
                                    <td class="d-flex align-items-center">
                                        <img alt="Watch" class="me-3 rounded" src="/images/products/3.png"
                                            width="60" />
                                        <div>
                    ...
                    <div class="mt-4">
                        <a class="fw-medium d-inline-flex align-items-center gap-1"
                            href="{{ url('/apps/ecommerce/products-grid') }}"> <i data-lucide="arrow-left"></i> Continue
                            Shopping </a>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a class="btn btn-lg btn-danger w-100 mb-3" href="apps-ecommerce-checkout.html"> Proceed to Checkout
                    </a>
                    <p class="text-muted text-center mb-0"><a class="fw-semibold" href="#">Create an account</a>
                        and get 239 bonuses</p>
                </div>
            </div>
            <div class="card">
                <div class="card-header">
                ...
                <div class="card-body">
                    <div class="alert alert-warning fs-xs py-2">Use <span class="fw-bold">ADMINPRO</span> to get 10% off.
                    </div>
