...
@section('content')
                ...
                <div class="card-header border-light justify-content-between">
                    <div class="d-flex gap-2">
                        <div class="app-search">
                            <input class="form-control" data-table-search="" placeholder="Search refunds..."
                                type="search" />
                    ...
                    <div class="d-flex gap-1">
                        <a class="btn btn-primary ms-1" data-bs-toggle="modal" href="#createRefundModal"> <i
                                class="fs-sm me-2" data-lucide="plus"></i> Create Refund </a>
                    </div>
                </div>
                    ...
                    <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <h5 class="fs-sm mb-0"><a class="link-reset"
                                            href="{{ url('/apps/ecommerce/order-details') }}">#INV-10423</a></h5>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <img alt="" class="rounded" height="34" src="/images/products/1.png"
                                            width="34" />
                                        <div>
                                ...
                                <td><img alt="" class="me-2" height="28" src="/images/cards/visa.svg" />
                                    xxxx 7832</td>
                                <td>$129.45</td>
                                <td>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center gap-1">
                                        <a class="btn btn-default btn-icon btn-sm rounded-circle" href="#!"><i
                                                class="fs-lg" data-lucide="check"></i></a>
                                        <a class="btn btn-default btn-icon btn-sm rounded-circle" href="#!"><i
                                                class="fs-lg" data-lucide="x"></i></a>
                                        <a class="btn btn-default btn-icon btn-sm rounded-circle" data-table-delete-row=""
                                            href="#"><i class="fs-lg" data-lucide="trash-2"></i></a>
                                        <button
                                            class="btn btn-default btn-icon btn-sm rounded-circle dropdown-toggle drop-arrow-none"
                                            data-bs-toggle="dropdown"><i class="fs-lg"
                            ...
                            <tr>
                                ...
                                <td>
                                    <h5 class="fs-sm mb-0"><a class="link-reset"
                                            href="{{ url('/apps/ecommerce/order-details') }}">#INV-10407</a></h5>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <img alt="" class="rounded" height="34" src="/images/products/2.png"
                                            width="34" />
                                        <div>
                                ...
                                <td><img alt="" class="me-2" height="28"
                                        src="/images/cards/mastercard.svg" /> xxxx 2294</td>
                                <td>$79.99</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h5 class="fs-sm mb-0"><a class="link-reset"
                                            href="{{ url('/apps/ecommerce/order-details') }}">#INV-10388</a></h5>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <img alt="" class="rounded" height="34" src="/images/products/3.png"
                                            width="34" />
                                        <div>
                                ...
                                <td><img alt="" class="me-2" height="28"
                                        src="/images/cards/american-express.svg" /> xxxx 1145</td>
                                <td>$249.00</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h5 class="fs-sm mb-0"><a class="link-reset"
                                            href="{{ url('/apps/ecommerce/order-details') }}">#INV-10352</a></h5>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <img alt="" class="rounded" height="34" src="/images/products/4.png"
                                            width="34" />
                                        <div>
                                ...
                                <td><img alt="" class="me-2" height="28" src="/images/cards/paypal.svg" />
                                    PayPal</td>
                                <td>$59.99</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h5 class="fs-sm mb-0"><a class="link-reset"
                                            href="{{ url('/apps/ecommerce/order-details') }}">#INV-10341</a></h5>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <img alt="" class="rounded" height="34" src="/images/products/5.png"
                                            width="34" />
                                        <div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <img alt="" class="rounded" height="34" src="/images/products/6.png"
                                            width="34" />
                                        <div>
                                ...
                                <td><img alt="" class="me-2" height="28"
                                        src="/images/cards/american-express.svg" /> xxxx 6730</td>
                                <td>$199.00</td>
                                <td><span class="badge badge-label badge-soft-success">Approved</span></td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <img alt="" class="rounded" height="34" src="/images/products/7.png"
                                            width="34" />
                                        <div>
                                ...
                                <td><img alt="" class="me-2" height="28"
                                        src="/images/cards/mastercard.svg" /> xxxx 8142</td>
                                <td>$89.50</td>
                                <td><span class="badge badge-label badge-soft-secondary">Refunded</span></td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <img alt="" class="rounded" height="34" src="/images/products/8.png"
                                            width="34" />
                                        <div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <img alt="" class="rounded" height="34" src="/images/products/9.png"
                                            width="34" />
                                        <div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <img alt="" class="rounded" height="34" src="/images/products/10.png"
                                            width="34" />
                                        <div>
                                ...
                                <td><img alt="" class="me-2" height="28"
                                        src="/images/cards/mastercard.svg" /> xxxx 3210</td>
                                <td>$64.99</td>
                                <td><span class="badge badge-label badge-soft-success">Approved</span></td>
    ...
    <div aria-hidden="true" aria-labelledby="createRefundModalLabel" class="modal fade" id="createRefundModal"
        tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title fw-semibold" id="createRefundModalLabel"><i class="me-2 text-primary"
                            data-lucide="credit-card"></i> Create Refund</h5>
                ...
                <form action="#!" method="post">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="refundCustomer" readonly="" type="text"
                                value="Mason Carter" />
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-semibold" for="refundReason">Reason</label>
                            <textarea class="form-control" id="refundReason"
                                placeholder="Enter refund reason (e.g., damaged item, wrong product, etc.)" rows="2"></textarea>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" id="refundAmount" placeholder="129.45" type="number"
                                    value="129.45" />
                            </div>
                        </div>
                        <div>
                            ...
                            <input class="form-control" data-date-format="d M, Y" data-provider="flatpickr"
                                id="refundDate" type="date" value="2025-10-08" />
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button class="btn btn-light" data-bs-dismiss="modal" type="button">Cancel</button>
                        <button class="btn btn-primary" type="submit"><i class="me-1" data-lucide="check"></i>
