                            ...
                            @foreach ($categories as $category)
                                    ...
                                    <td>
                                        <div class="d-flex gap-1">
                                            ...
                                            <button type="button"
                                                ...
                                                data-bs-target="#categoryDetailModal" data-id="{{ $category->id }}"
                                                data-name="{{ $category->name }}" data-slug="{{ $category->slug }}"
                                                data-description="{{ $category->description }}" data-type="Category"
                                                data-parent="" data-children="{{ $category->children->count() }}"
                                            ...
                                            @admincan('category.edit')
                                                <button type="button"
                                                    class="btn btn-default btn-icon
                                                                   btn-sm rounded-circle"
                                                    title="Edit" data-bs-toggle="modal" data-bs-target="#categoryModal"
                                ...
                                @foreach ($category->children as $child)
                                    <tr data-id="{{ $child->id }}">
                                        ...
                                        <td>
                                            <span class="ms-3">
                                                <i data-lucide="corner-down-right" class="text-muted me-1"
                                            ...
                                            <div class="d-flex gap-1">
                                                ...
                                                <button type="button"
                                                    class="btn btn-default btn-icon
                                                                   btn-sm rounded-circle"
                                                    title="View Details" data-bs-toggle="modal"
                                                    data-bs-target="#categoryDetailModal" data-id="{{ $child->id }}"
                                                    data-name="{{ $child->name }}" data-slug="{{ $child->slug }}"
                                                    data-description="{{ $child->description }}" data-type="Sub-category"
                                                    data-parent="{{ $category->name }}" data-children="—"
                                                ...
                                                @admincan('category.edit')
                                                    <button type="button"
                                                        class="btn btn-default btn-icon
                                                                       btn-sm rounded-circle"
                                                        title="Edit" data-bs-toggle="modal" data-bs-target="#categoryModal"
                                                        data-mode="edit" data-id="{{ $child->id }}"
                                                        data-name="{{ $child->name }}" data-slug="{{ $child->slug }}"
                                                ...
                                                @admincan('category.delete')
                                                    <button type="button"
                                                        class="btn btn-default btn-icon
                                                                       btn-sm rounded-circle"
                                                        title="Delete" data-bs-toggle="modal"
                                                        data-bs-target="#deleteCategoryModal" data-id="{{ $child->id }}"
                                                        data-name="{{ $child->name }}" data-children="0"
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control bg-light" id="categorySlug"
        ...
        <div class="modal fade" id="bulkDeleteModal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">Cancel</button>
                        <form id="bulkDeleteForm" action="{{ route('admin.ecommerce.category.bulk-destroy') }}"
                            method="POST">
                            @csrf
                            @method('DELETE')
