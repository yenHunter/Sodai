            ...
            <div class="card" data-table="" data-table-rows-per-page="8">
                <div class="card-header border-light justify-content-between">
                    ...
                    <div class="d-flex gap-1">
                        <a class="btn btn-danger ms-1" href="{{ url('/apps/ecommerce/order-add') }}"> <i
                                class="fs-sm me-2" data-lucide="plus"></i> Add Order </a>
                    </div>
                </div>
                    ...
                    <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <h5 class="fs-sm mb-0 fw-medium"><a class="link-reset"
                                            href="{{ url('/apps/ecommerce/order-details') }}">#WB20100</a></h5>
                                </td>
                                ...
                                <td>$129.45</td>
                                <td class="text-success fw-semibold"><i class="fs-sm" data-lucide="circle"></i> Paid
                                </td>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center gap-1">
                                        <a class="btn btn-default btn-icon btn-sm rounded-circle"
                                            href="{{ url('/apps/ecommerce/order-details') }}"><i class="fs-lg"
                                                data-lucide="eye"></i></a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h5 class="fs-sm mb-0 fw-medium"><a class="link-reset"
                                            href="{{ url('/apps/ecommerce/order-details') }}">#WB20101</a></h5>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h5 class="fs-sm mb-0 fw-medium"><a class="link-reset"
                                            href="{{ url('/apps/ecommerce/order-details') }}">#WB20102</a></h5>
                                </td>
                                ...
                                <td>$59.90</td>
                                <td class="text-danger fw-semibold"><i class="fs-sm" data-lucide="circle"></i> Failed
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h5 class="fs-sm mb-0 fw-medium"><a class="link-reset"
                                            href="{{ url('/apps/ecommerce/order-details') }}">#WB20103</a></h5>
                                </td>
                                ...
                                <td><img alt="" class="me-2" height="28" src="/images/cards/stripe.svg" />
                                    xxxx 9901</td>
                                <td>
                                    <div class="d-flex justify-content-center gap-1">
                                        <a class="btn btn-default btn-icon btn-sm rounded-circle"
                            ...
                            <tr>
                                ...
                                <td>
                                    <h5 class="fs-sm mb-0 fw-medium"><a class="link-reset"
                                            href="{{ url('/apps/ecommerce/order-details') }}">#WB20104</a></h5>
                                </td>
                                ...
                                <td><img alt="" class="me-2" height="28"
                                        src="/images/cards/american-express.svg" /> xxxx 4678</td>
                                <td>
                                    <div class="d-flex justify-content-center gap-1">
                                        <a class="btn btn-default btn-icon btn-sm rounded-circle"
                                            href="{{ url('/apps/ecommerce/order-details') }}"><i class="fs-lg"
                            ...
                            <tr>
                                ...
                                <td>
                                    <h5 class="fs-sm mb-0 fw-medium"><a class="link-reset"
                                            href="{{ url('/apps/ecommerce/order-details') }}">#WB30100</a></h5>
                                </td>
                                ...
                                <td><span class="badge badge-soft-success fs-xxs">Delivered</span></td>
                                <td><img alt="" class="me-2" height="28"
                                        src="/images/cards/discover-card.svg" /> xxxx 1234</td>
                                <td>
                                    <div class="d-flex justify-content-center gap-1">
                                        <a class="btn btn-default btn-icon btn-sm rounded-circle"
                                            href="{{ url('/apps/ecommerce/order-details') }}"><i class="fs-lg"
                            ...
                            <tr>
                                ...
                                <td>
                                    <h5 class="fs-sm mb-0 fw-medium"><a class="link-reset"
                                            href="{{ url('/apps/ecommerce/order-details') }}">#WB30101</a></h5>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h5 class="fs-sm mb-0 fw-medium"><a class="link-reset"
                                            href="{{ url('/apps/ecommerce/order-details') }}">#WB30102</a></h5>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h5 class="fs-sm mb-0 fw-medium"><a class="link-reset"
                                            href="{{ url('/apps/ecommerce/order-details') }}">#WB30103</a></h5>
                                </td>
                                ...
                                <td><span class="badge badge-soft-info fs-xxs">Shipped</span></td>
                                <td><img alt="" class="me-2" height="28"
                                        src="/images/cards/google-wallet.svg" /> xxx@google</td>
                                <td>
                                    <div class="d-flex justify-content-center gap-1">
                                        <a class="btn btn-default btn-icon btn-sm rounded-circle"
                                            href="{{ url('/apps/ecommerce/order-details') }}"><i class="fs-lg"
                            ...
                            <tr>
                                ...
                                <td>
                                    <h5 class="fs-sm mb-0 fw-medium"><a class="link-reset"
                                            href="{{ url('/apps/ecommerce/order-details') }}">#WB30104</a></h5>
                                </td>
