@extends('admin.include.vertical', ['title' => 'Create/Edit Order'])

@section('styles')
@endsection

@section('content')
    @include('admin.include.partials.page-title', ['subtitle' => 'Ecommerce', 'title' => 'Add/Edit Order'])
                    ...
                    <form id="orderForm">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input class="form-control" disabled="" id="orderId" placeholder="#WB20100"
                                    type="text" />
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Order Date</label>
                                <input class="form-control flatpickr-input" data-altformat="F j, Y"
                                    data-provider="flatpickr" id="orderDate" required="" type="datetime-local" />
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Customer Name</label>
                                <input class="form-control" id="customerName" placeholder="Mason Carter" required=""
                                    type="text" />
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Customer Email</label>
                                <input class="form-control" id="customerEmail" placeholder="mason.carter@shopmail.com"
                                    required="" type="email" />
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="amount" placeholder="129.45" required=""
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="cardNumber" maxlength="4" placeholder="7832"
                                    type="text" />
                            </div>
