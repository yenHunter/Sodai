...
@section('content')
    @include('admin.include.partials.page-title', ['subtitle' => 'Ecommerce', 'title' => 'Order Details'])
                    ...
                    <div class="card">
                        <div class="card-header align-items-start p-4">
                            <div>
                                ...
                                <p class="text-muted mb-3"><i data-lucide="calendar"></i> 24 Apr, 2025 <small
                                        class="text-muted">10:10 AM</small></p>
                                <span class="badge badge-soft-success fs-xxs badge-label"><i class="fs-sm align-middle"
                                        data-lucide="circle"></i> Paid</span>
                                <span class="badge badge-soft-info fs-xxs badge-label"><i class="fs-sm align-middle"
                                        data-lucide="truck"></i> Shipped</span>
                            </div>
                            <div class="ms-auto">
                                <a class="btn btn-light" href="javascript: void(0);"><i class="me-1"
                                        data-lucide="pencil"></i> Modify</a>
                                <a class="btn btn-danger" href="javascript: void(0);"><i class="me-1"
                                        data-lucide="trash-2"></i> Delete</a>
                            </div>
                        </div>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-1">
                                                            <a class="link-reset"
                                                                href="{{ url('/apps/ecommerce/product-details') }}">Wireless
                                                                Earbuds</a>
                                                        </h5>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-1">
                                                            <a class="link-reset"
                                                                href="{{ url('/apps/ecommerce/product-details') }}">Smart
                                                                Watch</a>
                                                        </h5>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-1">
                                                            <a class="link-reset"
                                                                href="{{ url('/apps/ecommerce/product-details') }}">Gaming
                                                                Mouse</a>
                                                        </h5>
                ...
                <div class="col-xl-3">
                    <div class="card">
                        <div class="card-header justify-content-between border-dashed">
                            ...
                            <a class="btn btn-default btn-sm btn-icon rounded-circle" href="#!"><i class="fs-lg"
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <a class="dropdown-item" href="#"><i class="me-2"
                                                        data-lucide="share-2"></i> Share</a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="#"><i class="me-2"
                                                        data-lucide="square-pen"></i> Edit</a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="#"><i class="me-2"
                                                        data-lucide="ban"></i> Block</a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item text-danger" href="#"><i class="me-2"
                                                        data-lucide="trash-2"></i> Delete</a>
                                            </li>
                                        </ul>
                                    </div>
