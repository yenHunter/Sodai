@extends('admin.include.vertical', ['title' => 'Dashboard'])

@section('styles')
@endsection

@section('content')
    @include('admin.include.partials.page-title', ['subtitle' => 'Dashboards', 'title' => 'eCommerce'])
                            ...
                            <div class="px-4 py-3">
                                <div class="d-flex justify-content-between mb-3">
                                    ...
                                    <a class="link-reset text-decoration-underline fw-semibold link-offset-3"
                                        href="#!">View Reports <i data-lucide="arrow-right"></i></a>
                                </div>
                                <div dir="ltr">
            ...
            <div class="card" data-table="" data-table-rows-per-page="7">
                <div class="card-header justify-content-between align-items-center border-dashed">
                    ...
                    <div class="d-flex gap-2">
                        <a class="btn btn-sm btn-soft-secondary" href="#!"> <i class="me-1" data-lucide="plus"></i>
                            Add Product </a>
                        <a class="btn btn-sm btn-primary" href="javascript:void(0);"> <i class="me-1"
                                data-lucide="download"></i> Export CSV </a>
                    </div>
                </div>
                <div class="card-body p-0">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <h5 class="fs-base mb-0"><a class="text-body" href="#!">Wireless
                                                        Earbuds</a></h5>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <h5 class="fs-base mb-0"><a class="text-body" href="#!">Laptop
                                                        Stand</a></h5>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <h5 class="fs-base mb-0"><a class="text-body" href="#!">Drone
                                                        Camera</a></h5>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <h5 class="fs-base mb-0"><a class="text-body" href="#!">Portable
                                                        Projector</a></h5>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <h5 class="fs-base mb-0"><a class="text-body" href="#!">Smartphone
                                                        G12</a></h5>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <span class="text-muted fs-xs">Audio</span>
                                                <h5 class="fs-base mb-0"><a class="text-body" href="#!">Noise
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <h5 class="fs-base mb-0"><a class="text-body" href="#!">Mini Air
                                                        Purifier</a></h5>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <span class="text-muted fs-xs">Accessories</span>
                                                <h5 class="fs-base mb-0"><a class="text-body" href="#!">USB-C
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <span class="text-muted fs-xs">Gadgets</span>
                                                <h5 class="fs-base mb-0"><a class="text-body" href="#!">Digital
                                                        Photo Frame</a></h5>
                                            </div>
                                        </div>
                                    </td>
        ...
        <div class="col-xxl-6">
            <div class="card" data-table="" data-table-rows-per-page="7">
                <div class="card-header justify-content-between align-items-center border-dashed">
                    ...
                    <div class="d-flex gap-2">
                        <a class="btn btn-sm btn-soft-secondary" href="#!"> <i class="me-1"
                                data-lucide="plus"></i> Add Product </a>
                        <a class="btn btn-sm btn-primary" href="javascript:void(0);"> <i class="me-1"
                                data-lucide="download"></i> Export CSV </a>
                    </div>
                </div>
