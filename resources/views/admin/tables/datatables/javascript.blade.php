@extends("shared.base", ["title" => "Javascript Source Datatables"])
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            <div class="container-fluid">
                @include("shared.partials.page-title", ["subtitle" => "DataTables", "title" => "Javascript Source"])
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header justify-content-between">
                                ...
                                <a class="icon-link icon-link-hover link-primary fw-semibold" href="https://datatables.net/examples/data_sources/js_array.html" target="_blank">
                                    View Docs
