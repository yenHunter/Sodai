@extends("admin.include.base", ["title" => "Basic Datatables"])
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            <div class="container-fluid">
                @include("admin.include.partials.page-title", ["subtitle" => "Tables", "title" => "Basic"])
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header justify-content-between">
                                ...
                                <a class="icon-link icon-link-hover link-primary fw-semibold" href="https://datatables.net/examples/basic_init/zero_configuration.html" target="_blank">
                                    View Docs
                        ...
                        <div class="card">
                            <div class="card-header justify-content-between">
                                ...
                                <a class="icon-link icon-link-hover link-primary fw-semibold" href="https://datatables.net/examples/advanced_init/complex_header.html" target="_blank">
                                    View Docs
                                    <i class="bi align-middle fs-lg" data-lucide="arrow-right"></i>
                                </a>
                            </div>
                            <div class="card-body">
                                <table class="table table-bordered dt-responsive align-middle mb-0" data-tables="basic">
                                    <thead class="thead-sm text-uppercase fs-xxs">
                                        <tr>
