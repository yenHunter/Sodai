@extends("shared.base", ["title" => "Export Data Datatables"])
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            <div class="container-fluid">
                @include("shared.partials.page-title", ["subtitle" => "Datatables", "title" => "Export Data"])
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header justify-content-between">
                                ...
                                <a class="icon-link icon-link-hover link-primary fw-semibold" href="https://datatables.net/reference/button/" target="_blank">
                                    View Docs
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-striped align-middle mt-2 mb-0" data-tables="export-data">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table class="table table-striped align-middle mb-0" data-tables="export-data-dropdown">
                                    <thead class="thead-sm text-uppercase fs-xxs">
                                        <tr>
                                            <th>Company</th>
                                            <th>Symbol</th>
...
@section("scripts")
    @vite(["resources/js/pages/datatables-export-data.js"])
@endsection
