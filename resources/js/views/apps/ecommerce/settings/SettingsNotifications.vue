...
<template>
  <VCard class="mb-6">
    <VCardText>
      ...
      <VTable class="notification-table text-no-wrap text-high-emphasis border rounded-xl mb-6">
        <thead>
          <tr>
            <th scope="col">
              TYPE
      ...
      <VTable class="notification-table border rounded-xl text-high-emphasis text-no-wrap mb-6">
        <thead>
          <tr>
            <th scope="col">
              TYPE
